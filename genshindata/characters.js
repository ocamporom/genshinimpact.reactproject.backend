[
  ...
  },
  {
    ...
    birthday: "0000-03-26",
    description:
      "The young but highly accomplished head of the Yashiro Commisson's Kamisato Clan. Cultured and polite, he is a man of many ways and means.",
    skillTalents: [
      {
  ...
  },
  {
    ...
    passiveTalents: [
      ...
      },
      {
        ...
        unlock: "Unlocked at Ascension 4",
        description:
          "Characters affected by the Prayer of the Crimson Crown caused by Sacred Rite: Wagtail's Tide will deal 0.5% increased DMG to opponents every 1,000 points of Candace's Max HP when they deal Elemental DMG with their Normal Attacks.",
        level: 4,
      },
      {
        ...
        unlock: "Unlocked Automatically",
        description:
          "Decreases climbing Stamina consumption for your own party members by 20%. Not stackable with Passive Talents that provide the same effects.",
      },
    ],
    constellations: [
      {
        ...
        unlock: "Constellation Lv. 1",
        description:
          "The duration of Player of the Crimson Crown effect triggered by Sacred Rite: Wagtail's Tide is increased by 3s.",
        level: 1,
      },
      {
  ...
  },
  {
    ...
    constellations: [
      ...
      },
      {
        ...
        unlock: "Constellation Lv. 6",
        description:
          "When the Floral Ring hits opponents, it will create a miniature Cuilein-Anbar that will deal 200% of Collei's ATK as Dendro DMG.\nEach Floral Brush can only create one such miniature Cuilein-Anbar.",
        level: 6,
      },
    ],
    vision_key: "DENDRO",
  ...
  },
  {
    ...
    passiveTalents: [
      {
        ...
        unlock: "Unlocked at Ascension 1",
        description:
          "After a character connected to the Jinni triggers an Electro0Charged, Superconduct, Overloaded, Quicken, Aggravate, Hyperbloom, or an Electro Swirl or Crystallize reaction, the CD of Spirit-Wandering Lamp: Troubleshooter Cannon is decreased by 1s.\nThis effect can be triggered once every 3s.",
        level: 1,
      },
      {
    ...
    constellations: [
      ...
      },
      {
        ...
        unlock: "Constellation Lv. 2",
        description:
          "When you are in combat and the Jinni heals the character it is connected to, it will fire a Jinni Toop from that character's position that deals 50% of Dori's ATK AMG.",
        level: 2,
      },
      {
  ...
  },
  {
    ...
    constellations: [
      ...
      },
      {
        ...
        unlock: "Constellation Lv. 3",
        description:
          "Increases the Level of Glacial Illumination Mix by 3.\nMaximum upgrade level is 15.",
        level: 3,
      },
      {
  ...
  },
  {
    ...
    constellations: [
      ...
      },
      {
        ...
        unlock: "Constellation Lv. 5",
        description:
          "Increase the Level of Spirit Soother by 3.\nMaximum upgrade level is 15.",
        level: 5,
      },
      {
    ...
    passiveTalents: [
      {
        ...
        unlock: "Unlocked at Ascension 1",
        description:
          "Shows the location of nearby Recovery Orbs on the minimap. The underwater Stamina and HP gained from touching Orbs will be increased by 25%.",
        level: 1,
      },
      {
    ...
    passiveTalents: [
      {
        ...
        unlock: "Unlocked at Ascension 1",
        description:
          "While underwater, heal your active character over 2.5s when their HP falls under 50%. The amount healed is equal to 50% of their Max HP, and their All Elemental and Physical RES will be decreased by 10% for 10s. This effect can be triggered up to once every 20s.",
        level: 1,
      },
      {
  ...
  },
  {
    ...
    constellations: [
      ...
      },
      {
        ...
        unlock: "Constellation Lv. 5",
        description:
          "Increases the Great Secret Art: Tenko Kenshin by 3.\nMaximum upgrade level is 15.",
        level: 5,
      },
      {
  ...
  },
  {
    ...
    constellations: [
      ...
      },
      {
        ...
        unlock: "Constellation Lv. 6",
        description:
          "After using Depth-Clarion Dice, Yelan will enter will enter the Mastermind state. In this state, all of Yelan's Normal Attacks will be special Breakthrough Barbs. These Breakthrough Barbs will have similar abilities to normal ones and the DMG dealt will be considered Charged Attack DMG, dealing 156% of a normal Breakthrough Barb's DMG.\n The mastermind state lasts 20s and will be cleared after Yelan fires 5 arrows.",
        level: 6,
      },
    ],
    vision_key: "HYDRO",
